...
L["Display number of items seen in the last scan in tooltip."] = true
L["Display total number of items ever seen in tooltip."] = true
...
L["If checked, the market value of the item will be displayed"] = true
L["If checked, the number of items seen in the last scan will be displayed."] = true
L["If checked, the number of items seen in the last scan will be displayed."] = true
L["If checked, the total number of items ever seen will be displayed."] = true
