...
L["AuctionDB - Global Market Value Median (via TSM App)"] = true
L["AuctionDB - Global Minimum Buyout Average (via TSM App)"] = true
L["AuctionDB - Global Minimum Buyout Median (via TSM App)"] = true
...
L["Display global market value median (via TSM Application) in the tooltip."] = true
L["Display global min buyout avg (via TSM Application) in the tooltip."] = true
L["Display global min buyout median (via TSM Application) in the tooltip."] = true
...
L["Global Market Value Median:"] = true
L["Global Market Value Median x%s:"] = true
L["Global Min Buyout Avg:"] = true
L["Global Min Buyout Avg x%s:"] = true
L["Global Min Buyout Median:"] = true
L["Global Min Buyout Median x%s:"] = true
...
L["If checked, the global market value median of the item will be displayed. This is provided exclusively via the TradeSkillMaster Application."] = true
...
L["If checked, the global minimum buyout median of the item will be displayed. This is provided exclusively via the TradeSkillMaster Application."] = true
