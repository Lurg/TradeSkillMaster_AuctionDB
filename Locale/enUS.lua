...
L["Ascending"] = true
L["AuctionDB - Global Market Value (via TSM App)"] = true
L["AuctionDB - Market Value"] = true
L["AuctionDB - Minimum Buyout"] = true
L["Can't run a GetAll scan right now."] = true
L["Descending"] = true
L["Display global market value (via TSM Application) in the tooltip."] = true
...
L["Global Market Value:"] = true
L["Global Market Value x%s:"] = true
...
L["If checked, the global market value of the item will be displayed. This is provided exclusively via the TradeSkillMaster Application."] = true
