	...
	local page = {
		{
			...
			children = {
				...
				{
					type = "CheckBox",
					label = L["Display global market value median (via TSM Application) in the tooltip."],
					relativeWidth = 1,
					disabled = not TSM.db.profile.tooltip,
					settingInfo = { TSM.db.profile, "globalMarketValueMedianTooltip" },
					tooltip = L["If checked, the global market value median of the item will be displayed. This is provided exclusively via the TradeSkillMaster Application."],
				},
				{
					type = "CheckBox",
				...
				{
					type = "CheckBox",
					label = L["Display global min buyout median (via TSM Application) in the tooltip."],
					relativeWidth = 1,
					disabled = not TSM.db.profile.tooltip,
					settingInfo = { TSM.db.profile, "globalMinBuyoutMedianTooltip" },
					tooltip = L["If checked, the global minimum buyout median of the item will be displayed. This is provided exclusively via the TradeSkillMaster Application."],
				},
			},
		},
	}
